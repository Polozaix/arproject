...
2. Point a controller ray at OBJECTIVES near the lower centre of the HUD and press the UI select trigger.
...
7. OBJECTIVES reopens the list in front of you, providing recovery if a card was placed out of reach.
